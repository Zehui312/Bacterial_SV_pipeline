...
# long_quality=15
# stat_frequency_script=/research/groups/ma1grp/home/zyu/work_2026/SV_2_Feb/SV_pipeline/Bacterial_SV_pipeline/stat_breakpoints.py
...
#+++++++++++++++++++++++Step 1 mapping Long ++++++++++++++++++++++
#=================================================================
mkdir -p ${output_path_dir}/1_mapping_Long
cd ${output_path_dir}/1_mapping_Long
...
#+++++++++++++++++++++++Step 2 SV calling ++++++++++++++++++++++++
#=================================================================
mkdir -p ${output_path_dir}/2_SV_calling
cd ${output_path_dir}/2_SV_calling


sniffles --input ${output_path_dir}/1_mapping_Long/${sample_name}.bam --vcf ${sample_name}_SV_chromosome.vcf --reference ${fna_ref_path} 

#=================================================================
#+++++++++++++++++++++++Step 3 Chimeric reads ++++++++++++++++++++
#=================================================================
mkdir -p ${output_path_dir}/3_Chimeric_reads
cd ${output_path_dir}/3_Chimeric_reads


samtools view -h ${output_path_dir}/1_mapping_Long/${sample_name}.bam | awk 'BEGIN {OFS="\t"} /^@/ || $0 ~ /SA:Z:/ {print $0}' > ${sample_name}_chimeric.sam
...
#=================================================================
mkdir -p ${output_path_dir}/4_SV_calling_chimeric
cd ${output_path_dir}/4_SV_calling_chimeric
sniffles --input ${output_path_dir}/3_Chimeric_reads/${sample_name}_chimeric.bam --vcf ${sample_name}_SV_chimeric_chromosome.vcf --reference ${fna_ref_path}

#=================================================================
#+++++++++++++++++++++++Step 5 stat frequency ++++++++++++++++++++
#=================================================================
mkdir -p ${output_path_dir}/5_SV_frequency
